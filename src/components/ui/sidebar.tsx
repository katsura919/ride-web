...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-2 py-2 flex flex-row md:hidden  items-center justify-between text-white"
        )}
        {...props}
      >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 bg-white text-white p-10 z-[100] flex flex-col justify-between",
                className
              )}
            >
              <div
